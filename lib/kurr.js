...
cpref = `Hayo Ngomongin Ronaldo Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
...
└─────────────────❒`
sendButLocation(from, `${menu}`, "*_© Ronaldoゑ_*", {jpegThumbnail:ofrply2,name:""}, [{buttonId:`store`,buttonText:{displayText:'KURRXD STORE'},type:1},{buttonId:`sc`,buttonText:{displayText:'ＳＥＷＡ　ＢＯＴ'},type:1},{buttonId:`catalog`,buttonText:{displayText:'CATALOG MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
Mau beli sc gw ? No enc? Yes! Pm langsung https://wa.me/message/ECSFOZWIENOPP1`
sendButLocation(from, `${menu}`, "*_© Ronaldoゑ_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`allmenu`,buttonText:{displayText:'ALL MENU'},type:1},{buttonId:`store`,buttonText:{displayText:'KURRXD STORE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
gifnya = await getBuffer('https://telegra.ph/file/457d3be9baecef635c357.mp4')
		anu =`*Ronaldo Store Melayani Jasa Pembuatan Vps/Rdp*
...
Mau beli sc bot noenc juga bisa

MINAT HUB https://wa.me/message/ECSFOZWIENOPP1
`
...
*SC? https://github.com/TsukasaCh/Bot-yteam*
(ERROR 60%)
...
*│*
*│*⬡ *PEMBAYARAN BISA VIA*
*│*⬡ *NO GOPAY : 0895803299969*
*│*⬡ *GOPAY QRCODE : SCAN DI ATAS AJA*
*└───────────────────*
Scan QR di atas bila belum premium`
kurr.sendMessage(from, dona, image, { quoted: ftrol, thumbnail: dona, caption: doni })
break
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    "hydratedContentText": `Hi ${pushname} 👋,\n\n${jmn} - ${week} ${weton} - ${calender}`,
    "hydratedFooterText": `Ronaldoゑ`,
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script Ronaldoゑ`,
          "url": "https://github.com/TsukasaCh/Bot-yteam"
        },
        "index": 0
      }
    ]
